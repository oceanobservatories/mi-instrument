...
def assert_environment():
    ...
    from mi.core.exceptions import ContainerStartupError
...
def assert_configuration(config):
    ...
    """
    from mi.core.exceptions import ContainerConfigError
    from mi.core.containers import is_basic_identifier
...
def bootstrap_pyon(logging_config_override=None, pyon_cfg=None):
    ...
    from mi.core.yaml_ordered_dict import apply_yaml_patch
    apply_yaml_patch()
    ...
    from mi.core.registry import IonObjectRegistry
