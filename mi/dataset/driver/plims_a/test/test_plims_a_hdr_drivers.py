...
from mi.dataset.driver.plims_a.plims_a_hdr_driver import parse as parse_telemetered
from mi.dataset.driver.plims_a.plims_a_hdr_recovered_driver import (
...
class PlimsAHdrDriverTest(unittest.TestCase):

    def test_telemetered(self):

        source_file_path = os.path.join(RESOURCE_PATH, 'D20231021T175900_IFCB199.hdr')
...
if __name__ == '__main__':
    test = PlimsAHdrDriverTest('test_one')
    test.test_one()
