...
def parse(unused, source_file_path, particle_data_handler):
    ...
    with open(source_file_path, 'rb') as stream_handle:
        ...
        driver = Vel3dCdDclRecoveredDriver(unused, stream_handle, particle_data_handler, source_file_path)
...
class Vel3dCdDclRecoveredDriver(SimpleDatasetDriver):
    ...
    def __init__(self, unused, stream_handle, particle_data_handler, source_file_path):
        ...
        super(Vel3dCdDclRecoveredDriver, self).__init__(unused, stream_handle, particle_data_handler)
    ...
    def _build_parser(self, stream_handle):
        ...
        return Vel3dCdDclParser(stream_handle, self._exception_callback, self.source_file_path, is_telemetered=False)
