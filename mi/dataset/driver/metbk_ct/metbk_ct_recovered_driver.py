...
from mi.dataset.parser.metbk_ct import MetbkCtParser
...
MODULE_NAME = 'mi.dataset.parser.metbk_ct'
PARTICLE_CLASS = 'MetbkCtInstrumentDataParticle'
...
def parse(unused, source_file_path, particle_data_handler):
    ...
    with open(source_file_path, "r") as stream_handle:
        ...
        parser = MetbkCtParser(parser_config, stream_handle, exception_callback)
