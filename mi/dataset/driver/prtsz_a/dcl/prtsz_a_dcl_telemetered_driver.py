...
def parse(unused, source_file_path, particle_data_handler):
    ...
    with open(source_file_path, 'rb') as stream_handle:
        ...
        PrtszADclTelemeteredDriver(unused, stream_handle, particle_data_handler).processFileStream()

    return particle_data_handler

class PrtszADclTelemeteredDriver(SimpleDatasetDriver):
    """
        The prtsz_a telemetered driver class extends the SimpleDatasetDriver.
    """

    def __init__(self, unused, stream_handle, particle_data_handler):

        super(PrtszADclTelemeteredDriver, self).__init__(unused, stream_handle, particle_data_handler)
