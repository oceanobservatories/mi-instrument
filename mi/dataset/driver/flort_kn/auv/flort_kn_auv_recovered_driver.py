...
@file mi/dataset/driver/dosta_ln/auv/flort_kn_auv_recovered_driver.py
@author Jeff Roy
...
def parse(unused, source_file_path, particle_data_handler):
    ...
    with open(source_file_path, 'rU') as stream_handle:
        ...
        driver = FlortKnAuvRecoveredDriver(unused, stream_handle, particle_data_handler)
        driver.processFileStream()

    return particle_data_handler


class FlortKnAuvRecoveredDriver(SimpleDatasetDriver):
    """
