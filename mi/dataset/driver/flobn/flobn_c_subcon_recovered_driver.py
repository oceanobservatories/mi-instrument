...
from mi.dataset.parser.flobn_cm_subcon import FlobnCSubconParser
...
def parse(unused, source_file_path, particle_data_handler):
    ...
    with open(source_file_path, 'r') as stream_handle:
        driver = FlobnCSubconRecoveredDriver(unused, stream_handle, particle_data_handler)
        driver.processFileStream()
    return particle_data_handler


class FlobnCSubconRecoveredDriver(SimpleDatasetDriver):
    """
    ...
    def _build_parser(self, stream_handle):
        ...
        parser = FlobnCSubconParser(parser_config,
                                    stream_handle,
