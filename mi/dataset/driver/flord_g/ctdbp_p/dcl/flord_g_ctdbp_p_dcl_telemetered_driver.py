...
@file mi-dataset/mi/dataset/driver/flord_g/ctdbp_p/dcl/flord_g_ctdbp_p_dcl_telemetered_driver.py
@author Jeff Roy
@brief Driver for the flord_g attached to the ctdbp_p_dcl instrument (Telemetered Data)
