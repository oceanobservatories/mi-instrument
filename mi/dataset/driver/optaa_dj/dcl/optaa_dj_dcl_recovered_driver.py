...
class OptaaDjDclRecoveredDriver:
    ...
    def process(self):
        ...
        with open(self._source_file_path, "rb") as file_handle:
            ...
            parser = OptaaDjDclParser(self._parser_config,
                                      file_handle, exception_callback, self._source_file_path, False)
...
def parse(unused, source_file_path, particle_data_handler):
    ...
    driver = OptaaDjDclRecoveredDriver(source_file_path, particle_data_handler, parser_config)
