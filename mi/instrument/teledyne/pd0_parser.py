...
class AdcpPd0Record(object):
    ...
    def _parse_sysconfig(self):
        ...
        sysconfig_format = (
            ...
            ('beam_angle', 0b1100000000, None),
            ('janus_config', 0b1111000000000000, None))
    ...
    def _parse_error_word(self):
        ...
        error_word_format = (
            ...
            ('pinging', 0b1 * 0xff, None),
            ('cold_wakeup', 0b1000000 * 0xff, None),
            ('unknown_wakeup', 0b10000000, None),
            ('clock_read', 0b1 * 0xffff, None),
            ('unexpected_alarm', 0b10 * 0xffff, None),
            ('clock_jump_forward', 0b100 * 0xffff, None),
            ('clock_jump_backward', 0b1000 * 0xffff, None),
            ('power_fail', 0b1000 * 0xffffff, None),
            ('spurious_dsp', 0b10000 * 0xffffff, None),
            ('spurious_uart', 0b100000 * 0xffffff, None),
            ('spurious_clock', 0b1000000 * 0xffffff, None),
            ('level_7_interrupt', 0b10000000 * 0xffffff, None),
        )
...
if __name__ == '__main__':
    ...
    print record.header, record.offsets
    print record.fixed_data
    print record.variable_data
    print record.velocities
    print record.correlation_magnitudes
    print record.echo_intensity
    print record.percent_good
    print record.sysconfig
    print record.sensor_source
    print record.sensor_avail
    print record.bit_result
    print record.error_word