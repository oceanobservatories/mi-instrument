...
from mi.instrument.teledyne.workhorse.particles import AdcpCompassCalibrationDataParticle, \
    ...
    AdcpPd0ErrorStatusParticle, Pd0BeamParticle, Pd0CoordinateTransformType, Pd0EarthParticle
...
class WorkhorseProtocol(CommandResponseInstrumentProtocol):
    ...
    def _got_chunk(self, chunk, timestamp):
        ...
        if ADCP_PD0_PARSED_REGEX_MATCHER.match(chunk):
            ...
            error = AdcpPd0ErrorStatusParticle(pd0, port_timestamp=timestamp).generate()
