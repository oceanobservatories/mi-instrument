...
parameter_names = {
    ...
    WorkhorseParameter.CLOCK_SYNCH_INTERVAL: 'Clock synch interval',
...
parameter_descriptions = {
    ...
    WorkhorseParameter.BANDWIDTH_CONTROL: '0=Wid,1=Nar',
...
parameter_defaults = {
    ...
    WorkhorseParameter.SLEEP_ENABLE: False,
    WorkhorseParameter.SAVE_NVRAM_TO_RECORDER: True,
...
parameter_expirations = {
    WorkhorseParameter.TIME: 86400,
}
...
class WorkhorseProtocol(CommandResponseInstrumentProtocol):
    ...
    def _build_param_dict(self):
        for param in parameter_regexes:
            self._param_dict.add(param,
                                 ...
                                 expiration=parameter_expirations.get(param))
    ...
    def apply_startup_params(self):
        ...
        if self.get_current_state() not in [WorkhorseProtocolState.COMMAND, WorkhorseProtocolState.AUTOSAMPLE]:
    ...
    def _set_params(self, *args, **kwargs):
        ...
        for key, val in params.iteritems():
            log.error('set_param: %r %r %r', key, val, old_config.get(key))
        ...
        if commands:
            ...
            self._get_response(expected_prompt='%s\r\n>' % commands[-1].strip())
    ...
    def _instrument_config_dirty(self):
        ...
        for param in startup_params:
            if not WorkhorseParameter.has(param):
    ...
    def _discover(self):
        ...
        """
        if self._is_logging():
            return WorkhorseProtocolState.AUTOSAMPLE, ResourceAgentState.STREAMING
        return WorkhorseProtocolState.COMMAND, ResourceAgentState.COMMAND

    def _sanitize(self, s):
        excluded = '\xb3\xbf\xc0\xd9\xda\xf8'
    ...
    def _handler_direct_access_exit(self, *args, **kwargs):
        ...
        """
        # TODO: Send break necessary to reset parameters?
        self._send_break()
