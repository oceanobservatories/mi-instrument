...
class Protocol(WorkhorseProtocol):
    ...
    def got_raw(self, port_agent_packet):
        ...
        """
        log.debug('Raw data: %r', port_agent_packet.get_as_dict())
    ...
    def got_raw2(self, port_agent_packet):
        ...
        sent by the driver to the instrument, the instrument responses,etc.
        """
        log.debug('Raw 2 data: %r', port_agent_packet.get_as_dict())
    ...
    def _send_break(self, duration=3000):
        ...
        break_confirmation = []
        log.debug("self._linebuf = %r", self._linebuf)
    ...
    def _send_break2(self, duration=3000):
        ...
        break_confirmation = []
        log.debug("self._linebuf2 = %r", self._linebuf2)
    ...
    def _instrument_config_dirty2(self):
        ...
        log.debug("Startup Parameters 5th beam: %s" % startup_params2)
    ...
    def _set_params2(self, *args, **kwargs):
        ...
        try:
            ...
            pass
        log.debug("_set_params 2 calling _verify_not_readonly ARGS = " + repr(args))
        ...
        log.debug("_set_params 2 calling _update_params")
    ...
    def apply_startup_params2(self):
        ...
        if not self._instrument_config_dirty2():
            log.debug("in apply_startup_params2 returning True")
            return True
    ...
    def get_startup_config2(self):
        ...
        log.debug("Startup list 2: %s", start_list)
    ...
    def _handler_get(self, *args, **kwargs):
        ...
        log.debug("expire_time = " + str(expire_time))
