...
"""
from mi.instrument.teledyne.workhorse.particles import VADCPDataParticleType, AdcpCompassCalibrationKey, \
    AdcpSystemConfigurationKey, AdcpPd0ParsedKey, AdcpAncillarySystemDataKey, AdcpTransmitPathKey
...
from mi.instrument.teledyne.workhorse.vadcp.driver import VadcpParameter, WorkhorseParameter2, NEWLINE
from mi.instrument.teledyne.workhorse.vadcp.driver import VadcpParameter2
from mi.instrument.teledyne.workhorse.driver import WorkhorseScheduledJob, WorkhorseCapability, \
    WorkhorseProtocolState, WorkhorseProtocolEvent, WorkhorsePrompt
...
InstrumentDriverTestCase.initialize(
    ...
    driver_startup_config={
        DriverStartupConfigKey.PARAMETERS: {
            VadcpParameter.SERIAL_FLOW_CONTROL: '11110',
            VadcpParameter.BANNER: False,
            VadcpParameter.INSTRUMENT_ID: 0,
            VadcpParameter.SLEEP_ENABLE: 0,
            VadcpParameter.SAVE_NVRAM_TO_RECORDER: True,
            VadcpParameter.POLLED_MODE: False,
            VadcpParameter.XMIT_POWER: 255,
            VadcpParameter.SPEED_OF_SOUND: 1485,
            VadcpParameter.PITCH: 0,
            VadcpParameter.ROLL: 0,
            VadcpParameter.SALINITY: 35,
            VadcpParameter.COORDINATE_TRANSFORMATION: '00111',
            VadcpParameter.TIME_PER_ENSEMBLE: '00:00:00.00',
            VadcpParameter.TIME_PER_PING: '00:01.00',
            VadcpParameter.FALSE_TARGET_THRESHOLD: '050,001',
            VadcpParameter.BANDWIDTH_CONTROL: 0,
            VadcpParameter.CORRELATION_THRESHOLD: 64,
            VadcpParameter.SERIAL_OUT_FW_SWITCHES: '111100000',
            VadcpParameter.ERROR_VELOCITY_THRESHOLD: 2000,
            VadcpParameter.BLANK_AFTER_TRANSMIT: 88,
            VadcpParameter.CLIP_DATA_PAST_BOTTOM: 0,
            VadcpParameter.RECEIVER_GAIN_SELECT: 1,
            VadcpParameter.NUMBER_OF_DEPTH_CELLS: 22,
            VadcpParameter.PINGS_PER_ENSEMBLE: 1,
            VadcpParameter.DEPTH_CELL_SIZE: 100,
            VadcpParameter.TRANSMIT_LENGTH: 0,
            VadcpParameter.PING_WEIGHT: 0,
            VadcpParameter.AMBIGUITY_VELOCITY: 175,
            VadcpParameter.LATENCY_TRIGGER: 0,
            VadcpParameter.HEADING_ALIGNMENT: +00000,
            VadcpParameter.HEADING_BIAS: +00000,
            VadcpParameter.TRANSDUCER_DEPTH: 2000,
            VadcpParameter.DATA_STREAM_SELECTION: 0,
            VadcpParameter.ENSEMBLE_PER_BURST: 0,
            VadcpParameter.SAMPLE_AMBIENT_SOUND: 0,
            VadcpParameter.BUFFERED_OUTPUT_PERIOD: '00:00:00',

            VadcpParameter.SYNC_PING_ENSEMBLE: '001',
            VadcpParameter.RDS3_MODE_SEL: 1,
            VadcpParameter.SYNCH_DELAY: 100,

            # Slave
            VadcpParameter2.SERIAL_FLOW_CONTROL: '11110',
            VadcpParameter2.BANNER: False,
            VadcpParameter2.INSTRUMENT_ID: 0,
            VadcpParameter2.SLEEP_ENABLE: 0,
            VadcpParameter2.SAVE_NVRAM_TO_RECORDER: True,
            VadcpParameter2.POLLED_MODE: False,
            VadcpParameter2.XMIT_POWER: 255,
            VadcpParameter2.SPEED_OF_SOUND: 1485,
            VadcpParameter2.PITCH: 0,
            VadcpParameter2.ROLL: 0,
            VadcpParameter2.SALINITY: 35,
            VadcpParameter2.COORDINATE_TRANSFORMATION: '00111',
            VadcpParameter2.TIME_PER_ENSEMBLE: '00:00:00.00',
            VadcpParameter2.FALSE_TARGET_THRESHOLD: '050,001',
            VadcpParameter2.BANDWIDTH_CONTROL: 0,
            VadcpParameter2.CORRELATION_THRESHOLD: 64,
            VadcpParameter2.SERIAL_OUT_FW_SWITCHES: '111100000',
            VadcpParameter2.ERROR_VELOCITY_THRESHOLD: 2000,
            VadcpParameter2.BLANK_AFTER_TRANSMIT: 83,
            VadcpParameter2.CLIP_DATA_PAST_BOTTOM: 0,
            VadcpParameter2.RECEIVER_GAIN_SELECT: 1,
            VadcpParameter2.NUMBER_OF_DEPTH_CELLS: 22,
            VadcpParameter2.PINGS_PER_ENSEMBLE: 1,
            VadcpParameter2.DEPTH_CELL_SIZE: 94,
            VadcpParameter2.TRANSMIT_LENGTH: 0,
            VadcpParameter2.PING_WEIGHT: 0,
            VadcpParameter2.AMBIGUITY_VELOCITY: 175,
            VadcpParameter2.LATENCY_TRIGGER: 0,
            VadcpParameter2.HEADING_ALIGNMENT: +00000,
            VadcpParameter2.HEADING_BIAS: +00000,
            VadcpParameter2.TRANSDUCER_DEPTH: 2000,
            VadcpParameter2.DATA_STREAM_SELECTION: 0,
            VadcpParameter2.ENSEMBLE_PER_BURST: 0,
            VadcpParameter2.SAMPLE_AMBIENT_SOUND: 0,
            VadcpParameter2.BUFFERED_OUTPUT_PERIOD: '00:00:00',

            VadcpParameter2.SYNC_PING_ENSEMBLE: '001',
            VadcpParameter2.RDS3_MODE_SEL: 2,
            VadcpParameter2.SYNCH_DELAY: 0,

            VadcpParameter.CLOCK_SYNCH_INTERVAL: '00:00:00',
            VadcpParameter.GET_STATUS_INTERVAL: '00:00:00',
        },
...
class VADCPMixin(DriverTestMixin):
    ...
    _vadcp_driver_parameters = {
        VadcpParameter.SERIAL_DATA_OUT: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '000 000 000',
                                    VALUE: '000 000 000'},
        VadcpParameter.SERIAL_FLOW_CONTROL: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '11110',
                                        VALUE: '11110'},
        VadcpParameter.SAVE_NVRAM_TO_RECORDER: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: True,
                                           VALUE: True},
        VadcpParameter.TIME: {TYPE: str, READONLY: False, DA: False, STARTUP: False, DEFAULT: False},
        VadcpParameter.SERIAL_OUT_FW_SWITCHES: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '111100000',
                                           VALUE: '111100000'},
        VadcpParameter.BANNER: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: False, VALUE: False},
        VadcpParameter.INSTRUMENT_ID: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.SLEEP_ENABLE: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.POLLED_MODE: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: False, VALUE: False},
        VadcpParameter.XMIT_POWER: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 255, VALUE: 255},
        VadcpParameter.SPEED_OF_SOUND: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1485, VALUE: 1485},
        VadcpParameter.PITCH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.ROLL: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.SALINITY: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 35, VALUE: 35},
        VadcpParameter.COORDINATE_TRANSFORMATION: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '00111',
                                              VALUE: '00111'},
        VadcpParameter.SENSOR_SOURCE: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: "1111101",
                                  VALUE: "1111101"},
        VadcpParameter.TIME_PER_ENSEMBLE: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: False,
                                      VALUE: '00:00:00.00'},
        VadcpParameter.TIME_OF_FIRST_PING: {TYPE: str, READONLY: True, DA: False, STARTUP: False, DEFAULT: False},

        VadcpParameter.TIME_PER_PING: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: '00:01.00',
                                  VALUE: '00:01.00'},
        VadcpParameter.FALSE_TARGET_THRESHOLD: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: '050,001',
                                           VALUE: '050,001'},
        VadcpParameter.BANDWIDTH_CONTROL: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        VadcpParameter.CORRELATION_THRESHOLD: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 64, VALUE: 64},
        VadcpParameter.ERROR_VELOCITY_THRESHOLD: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 2000,
                                             VALUE: 2000},
        VadcpParameter.BLANK_AFTER_TRANSMIT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 88, VALUE: 88},
        VadcpParameter.CLIP_DATA_PAST_BOTTOM: {TYPE: bool, READONLY: False, DA: True, STARTUP: True, DEFAULT: False,
                                          VALUE: 0},
        VadcpParameter.RECEIVER_GAIN_SELECT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        VadcpParameter.NUMBER_OF_DEPTH_CELLS: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 220, VALUE: 220},
        VadcpParameter.PINGS_PER_ENSEMBLE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        VadcpParameter.DEPTH_CELL_SIZE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 100, VALUE: 100},
        VadcpParameter.TRANSMIT_LENGTH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        VadcpParameter.PING_WEIGHT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        VadcpParameter.AMBIGUITY_VELOCITY: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 175, VALUE: 175},
        VadcpParameter.LATENCY_TRIGGER: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.HEADING_ALIGNMENT: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: +00000,
                                      VALUE: +00000},
        VadcpParameter.HEADING_BIAS: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: +00000,
                                 VALUE: +00000},
        VadcpParameter.TRANSDUCER_DEPTH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 2000, VALUE: 2000},
        VadcpParameter.DATA_STREAM_SELECTION: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.ENSEMBLE_PER_BURST: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.BUFFERED_OUTPUT_PERIOD: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '00:00:00',
                                           VALUE: '00:00:00'},
        VadcpParameter.SAMPLE_AMBIENT_SOUND: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter.SYNC_PING_ENSEMBLE: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '001',
                                       VALUE: '001'},
        VadcpParameter.RDS3_MODE_SEL: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        VadcpParameter.SYNCH_DELAY: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 100, VALUE: 100},

        VadcpParameter.CLOCK_SYNCH_INTERVAL: {TYPE: str, READONLY: False, DA: False, STARTUP: True, DEFAULT: '00:00:00',
                                         VALUE: '00:00:00'},
        VadcpParameter.GET_STATUS_INTERVAL: {TYPE: str, READONLY: False, DA: False, STARTUP: True, DEFAULT: '00:00:00',
                                        VALUE: '00:00:00'}
    }

    _driver_parameters_slave = {
        VadcpParameter2.SERIAL_DATA_OUT: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '000 000 000',
                                     VALUE: '000 000 000'},
        VadcpParameter2.SERIAL_FLOW_CONTROL: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '11110',
                                         VALUE: '11110'},
        VadcpParameter2.SAVE_NVRAM_TO_RECORDER: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: True,
                                            VALUE: True},
        VadcpParameter2.TIME: {TYPE: str, READONLY: False, DA: False, STARTUP: False, DEFAULT: False},
        VadcpParameter2.SERIAL_OUT_FW_SWITCHES: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '111100000',
                                            VALUE: '111100000'},
        VadcpParameter2.BANNER: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: False, VALUE: False},
        VadcpParameter2.INSTRUMENT_ID: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.SLEEP_ENABLE: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.POLLED_MODE: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: False, VALUE: False},
        VadcpParameter2.XMIT_POWER: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 255, VALUE: 255},
        VadcpParameter2.SPEED_OF_SOUND: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1485, VALUE: 1485},
        VadcpParameter2.PITCH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.ROLL: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.SALINITY: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 35, VALUE: 35},
        VadcpParameter2.COORDINATE_TRANSFORMATION: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '00111',
                                               VALUE: '00111'},
        VadcpParameter2.SENSOR_SOURCE: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: "1111101",
                                   VALUE: "1111101"},
        VadcpParameter2.TIME_PER_ENSEMBLE: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: False,
                                       VALUE: '00:00:00.00'},
        VadcpParameter2.TIME_OF_FIRST_PING: {TYPE: str, READONLY: True, DA: False, STARTUP: False, DEFAULT: False},
        VadcpParameter2.FALSE_TARGET_THRESHOLD: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: '050,001',
                                            VALUE: '050,001'},
        VadcpParameter2.BANDWIDTH_CONTROL: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        VadcpParameter2.CORRELATION_THRESHOLD: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 64, VALUE: 64},
        VadcpParameter2.ERROR_VELOCITY_THRESHOLD: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 2000,
                                              VALUE: 2000},
        VadcpParameter2.BLANK_AFTER_TRANSMIT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 83, VALUE: 83},
        VadcpParameter2.CLIP_DATA_PAST_BOTTOM: {TYPE: bool, READONLY: False, DA: True, STARTUP: True, DEFAULT: False,
                                           VALUE: 0},
        VadcpParameter2.RECEIVER_GAIN_SELECT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        VadcpParameter2.NUMBER_OF_DEPTH_CELLS: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 22, VALUE: 22},
        VadcpParameter2.PINGS_PER_ENSEMBLE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        VadcpParameter2.DEPTH_CELL_SIZE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 94, VALUE: 94},
        VadcpParameter2.TRANSMIT_LENGTH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        VadcpParameter2.PING_WEIGHT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        VadcpParameter2.AMBIGUITY_VELOCITY: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 175, VALUE: 175},
        VadcpParameter2.LATENCY_TRIGGER: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.HEADING_ALIGNMENT: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: +00000,
                                       VALUE: +00000},
        VadcpParameter2.HEADING_BIAS: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: +00000,
                                  VALUE: +00000},
        VadcpParameter2.TRANSDUCER_DEPTH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 2000, VALUE: 2000},
        VadcpParameter2.DATA_STREAM_SELECTION: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.ENSEMBLE_PER_BURST: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.BUFFERED_OUTPUT_PERIOD: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '00:00:00',
                                            VALUE: '00:00:00'},
        VadcpParameter2.SAMPLE_AMBIENT_SOUND: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.SYNC_PING_ENSEMBLE: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '001',
                                        VALUE: '001'},
        VadcpParameter2.RDS3_MODE_SEL: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 2, VALUE: 2},
        VadcpParameter2.SLAVE_TIMEOUT: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        VadcpParameter2.SYNCH_DELAY: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
    }
    ...
    _driver_capabilities = {
        ...
        WorkhorseCapability.GET_CALIBRATION: {STATES: [WorkhorseProtocolState.COMMAND]},
        WorkhorseCapability.RUN_TEST_200: {STATES: [WorkhorseProtocolState.COMMAND]},
...
class VadcpDriverUnitTest(WorkhorseDriverUnitTest, VADCPMixin):
    ...
    def assert_initialize_driver(self, driver, initial_protocol_state=WorkhorseProtocolState.COMMAND):
        ...
        # self.assert_force_all_slave_states(driver, WorkhorseProtocolState.COMMAND)
    ...
    def test_driver_parameters(self):
        ...
        expected_parameters_master = sorted(self._vadcp_driver_parameters.keys())
        ...
        reported_parameters = sorted(driver.get_resource(VadcpParameter.ALL))
    ...
    def test_driver_enums(self):
        ...
        self.assert_enum_has_no_duplicates(VadcpParameter)
...
###############################################################################
@attr('INT', group='mi')
class IntFromIDK(WorkhorseDriverIntegrationTest, VADCPMixin):
    _tested = {}
    ...
    def test_autosample_particle_generation(self):
        ...
        params = {
            ...
            VadcpParameter.PING_WEIGHT: 0,
            VadcpParameter.AMBIGUITY_VELOCITY: 175,
            VadcpParameter.TRANSDUCER_DEPTH: 8000,
        }
        self.assert_set_bulk(params)

        self.assert_driver_command(WorkhorseProtocolEvent.START_AUTOSAMPLE, state=WorkhorseProtocolState.AUTOSAMPLE, delay=1)
        self.assert_async_particle_generation(VADCPDataParticleType.VADCP_PD0_BEAM_PARSED,
                                              self.assert_particle_pd0_data,
                                              timeout=40)

        self.assert_driver_command(WorkhorseProtocolEvent.STOP_AUTOSAMPLE, state=WorkhorseProtocolState.COMMAND, delay=10)
    ...
    def test_commands(self):
        ...
        ####
        self.assert_driver_command(WorkhorseProtocolEvent.GET_CONFIGURATION)
        ...
        self.assert_driver_command(WorkhorseProtocolEvent.STOP_AUTOSAMPLE, state=WorkhorseProtocolState.COMMAND,
                                   delay=1)
        self.assert_driver_command(WorkhorseProtocolEvent.GET_CALIBRATION)
        self.assert_driver_command(WorkhorseProtocolEvent.GET_CONFIGURATION)
        ...
        self.assert_driver_command(WorkhorseProtocolEvent.SAVE_SETUP_TO_RAM,
                                   expected="Parameters saved as USER defaults")
        self.assert_driver_command(WorkhorseProtocolEvent.GET_ERROR_STATUS_WORD, regex='^........')
        self.assert_driver_command(WorkhorseProtocolEvent.CLEAR_ERROR_STATUS_WORD, regex='^Error Status Word Cleared')
        self.assert_driver_command(WorkhorseProtocolEvent.GET_FAULT_LOG, regex='^Total Unique Faults   =.*')
        self.assert_driver_command(WorkhorseProtocolEvent.CLEAR_FAULT_LOG,
                                   expected='FC ..........\r\n Fault Log Cleared.\r\nClearing buffer @0x00801000\r\nDone [i=2048].\r\n')
        self.assert_driver_command(WorkhorseProtocolEvent.RUN_TEST_200, regex='^  Ambient  Temperature =')
        self.assert_driver_command(WorkhorseProtocolEvent.USER_SETS)
        ...
        # self.assert_driver_command(WorkhorseProtocolEvent.FACTORY_SETS)
        #
        ...
        self.assert_driver_command(WorkhorseProtocolEvent.START_AUTOSAMPLE,
                                   state=WorkhorseProtocolState.AUTOSAMPLE,
                                   delay=1)
        self.assert_driver_command_exception(WorkhorseProtocolEvent.SAVE_SETUP_TO_RAM,
                                             exception_class=InstrumentCommandException)
        self.assert_driver_command_exception(WorkhorseProtocolEvent.GET_ERROR_STATUS_WORD,
                                             exception_class=InstrumentCommandException)
        self.assert_driver_command_exception(WorkhorseProtocolEvent.CLEAR_ERROR_STATUS_WORD,
                                             exception_class=InstrumentCommandException)
        self.assert_driver_command_exception(WorkhorseProtocolEvent.GET_FAULT_LOG,
                                             exception_class=InstrumentCommandException)
        self.assert_driver_command_exception(WorkhorseProtocolEvent.CLEAR_FAULT_LOG,
                                             exception_class=InstrumentCommandException)
        self.assert_driver_command_exception(WorkhorseProtocolEvent.RUN_TEST_200,
                                             exception_class=InstrumentCommandException)
        self.assert_driver_command(WorkhorseProtocolEvent.SCHEDULED_GET_STATUS)
        ...
        self.assert_driver_command_exception(WorkhorseProtocolEvent.CLOCK_SYNC,
                                             exception_class=InstrumentCommandException)
        self.assert_driver_command(WorkhorseProtocolEvent.SCHEDULED_CLOCK_SYNC)
        self.assert_driver_command(WorkhorseProtocolEvent.GET_CALIBRATION, regex=r'Calibration date and time:')
        self.assert_driver_command(WorkhorseProtocolEvent.GET_CONFIGURATION, regex=r' Instrument S/N')
        self.assert_driver_command(WorkhorseProtocolEvent.STOP_AUTOSAMPLE, state=WorkhorseProtocolState.COMMAND,
                                   delay=1)
    ...
    def _tst_set_xmit_power_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.XMIT_POWER, 0)
        self.assert_set(WorkhorseParameter2.XMIT_POWER, 128)
        self.assert_set(WorkhorseParameter2.XMIT_POWER, 254)

        self.assert_set_exception(WorkhorseParameter2.XMIT_POWER, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.XMIT_POWER, 256)
        self.assert_set_exception(WorkhorseParameter2.XMIT_POWER, -1)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.XMIT_POWER,
                        self._driver_parameters_slave[WorkhorseParameter2.XMIT_POWER][self.VALUE])
    ...
    def _tst_set_pitch_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.PITCH, -6000)
        self.assert_set(WorkhorseParameter2.PITCH, -4000)
        self.assert_set(WorkhorseParameter2.PITCH, -2000)
        self.assert_set(WorkhorseParameter2.PITCH, -1)
        self.assert_set(WorkhorseParameter2.PITCH, 0)
        self.assert_set(WorkhorseParameter2.PITCH, 1)
        self.assert_set(WorkhorseParameter2.PITCH, 2000)
        self.assert_set(WorkhorseParameter2.PITCH, 4000)
        self.assert_set(WorkhorseParameter2.PITCH, 6000)

        self.assert_set_exception(WorkhorseParameter2.PITCH, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.PITCH, -6001)
        self.assert_set_exception(WorkhorseParameter2.PITCH, 6001)
        self.assert_set_exception(WorkhorseParameter2.PITCH, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.PITCH, self._driver_parameters_slave[WorkhorseParameter2.PITCH][self.VALUE])
    ...
    def _tst_set_roll_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.ROLL, -6000)
        self.assert_set(WorkhorseParameter2.ROLL, -4000)
        self.assert_set(WorkhorseParameter2.ROLL, -2000)
        self.assert_set(WorkhorseParameter2.ROLL, -1)
        self.assert_set(WorkhorseParameter2.ROLL, 0)
        self.assert_set(WorkhorseParameter2.ROLL, 1)
        self.assert_set(WorkhorseParameter2.ROLL, 2000)
        self.assert_set(WorkhorseParameter2.ROLL, 4000)
        self.assert_set(WorkhorseParameter2.ROLL, 6000)

        self.assert_set_exception(WorkhorseParameter2.ROLL, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.ROLL, -6001)
        self.assert_set_exception(WorkhorseParameter2.ROLL, 6001)
        self.assert_set_exception(WorkhorseParameter2.ROLL, 3.1415926)
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.ROLL, self._driver_parameters_slave[WorkhorseParameter2.ROLL][self.VALUE])
    ...
    def _tst_set_speed_of_sound_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.SPEED_OF_SOUND, 1400)
        self.assert_set(WorkhorseParameter2.SPEED_OF_SOUND, 1450)
        self.assert_set(WorkhorseParameter2.SPEED_OF_SOUND, 1500)
        self.assert_set(WorkhorseParameter2.SPEED_OF_SOUND, 1550)
        self.assert_set(WorkhorseParameter2.SPEED_OF_SOUND, 1600)

        self.assert_set_exception(WorkhorseParameter2.SPEED_OF_SOUND, 0)
        self.assert_set_exception(WorkhorseParameter2.SPEED_OF_SOUND, 1399)
        self.assert_set_exception(WorkhorseParameter2.SPEED_OF_SOUND, 1601)
        self.assert_set_exception(WorkhorseParameter2.SPEED_OF_SOUND, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.SPEED_OF_SOUND, -256)
        self.assert_set_exception(WorkhorseParameter2.SPEED_OF_SOUND, -1)
        self.assert_set_exception(WorkhorseParameter2.SPEED_OF_SOUND, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.SPEED_OF_SOUND,
                        self._driver_parameters_slave[WorkhorseParameter2.SPEED_OF_SOUND][self.VALUE])
    ...
    def _tst_set_salinity_slave(self):
        ...
        # SALINITY:  -- Int (0 - 40)
        self.assert_set(WorkhorseParameter2.SALINITY, 1)
        self.assert_set(WorkhorseParameter2.SALINITY, 10)
        self.assert_set(WorkhorseParameter2.SALINITY, 20)
        self.assert_set(WorkhorseParameter2.SALINITY, 30)
        self.assert_set(WorkhorseParameter2.SALINITY, 40)

        self.assert_set_exception(WorkhorseParameter2.SALINITY, "LEROY JENKINS")

        # AssertionError: Unexpected exception: ES no value match (40 != -1)
        self.assert_set_exception(WorkhorseParameter2.SALINITY, -1)

        # AssertionError: Unexpected exception: ES no value match (35 != 41)
        self.assert_set_exception(WorkhorseParameter2.SALINITY, 41)

        self.assert_set_exception(WorkhorseParameter2.SALINITY, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.SALINITY,
                        self._driver_parameters_slave[WorkhorseParameter2.SALINITY][self.VALUE])
    ...
    def _tst_set_sensor_source_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.SENSOR_SOURCE, "0000000")
        self.assert_set(WorkhorseParameter2.SENSOR_SOURCE, "1111101")
        self.assert_set(WorkhorseParameter2.SENSOR_SOURCE, "1010101")
        self.assert_set(WorkhorseParameter2.SENSOR_SOURCE, "0101000")
        self.assert_set(WorkhorseParameter2.SENSOR_SOURCE, "1100100")
        ...
        # self.assert_set(WorkhorseParameter2.SENSOR_SOURCE, "1111101")
        #
        self.assert_set_exception(WorkhorseParameter2.SENSOR_SOURCE, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.SENSOR_SOURCE, 2)
        self.assert_set_exception(WorkhorseParameter2.SENSOR_SOURCE, -1)
        self.assert_set_exception(WorkhorseParameter2.SENSOR_SOURCE, "1111112")
        self.assert_set_exception(WorkhorseParameter2.SENSOR_SOURCE, "11111112")
        self.assert_set_exception(WorkhorseParameter2.SENSOR_SOURCE, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.SENSOR_SOURCE,
                        self._driver_parameters_slave[WorkhorseParameter2.SENSOR_SOURCE][self.VALUE])
    ...
    def _tst_set_time_per_ensemble_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.TIME_PER_ENSEMBLE, "00:00:00.00")
        self.assert_set(WorkhorseParameter2.TIME_PER_ENSEMBLE, "00:00:01.00")
        self.assert_set(WorkhorseParameter2.TIME_PER_ENSEMBLE, "00:01:00.00")

        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, '30:30:30.30')
        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, '59:59:59.99')
        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, 2)
        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, -1)
        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, '99:99:99.99')
        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, '-1:-1:-1.+1')
        self.assert_set_exception(WorkhorseParameter2.TIME_PER_ENSEMBLE, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.TIME_PER_ENSEMBLE,
                        self._driver_parameters_slave[WorkhorseParameter2.TIME_PER_ENSEMBLE][self.VALUE])
    ...
    def _tst_set_false_target_threshold_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "000,000")
        self.assert_set(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "255,000")
        self.assert_set(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "000,255")
        self.assert_set(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "255,255")

        self.assert_set_exception(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "256,000")
        self.assert_set_exception(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "256,255")
        self.assert_set_exception(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "000,256")
        self.assert_set_exception(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "255,256")
        self.assert_set_exception(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, -1)

        self.assert_set_exception(WorkhorseParameter2.FALSE_TARGET_THRESHOLD, "LEROY JENKINS")

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.FALSE_TARGET_THRESHOLD,
                        self._driver_parameters_slave[WorkhorseParameter2.FALSE_TARGET_THRESHOLD][self.VALUE])
    ...
    def _tst_set_bandwidth_control_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.BANDWIDTH_CONTROL, 1)

        self.assert_set_exception(WorkhorseParameter2.BANDWIDTH_CONTROL, -1)
        self.assert_set_exception(WorkhorseParameter2.BANDWIDTH_CONTROL, 2)
        self.assert_set_exception(WorkhorseParameter2.BANDWIDTH_CONTROL, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.BANDWIDTH_CONTROL, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.BANDWIDTH_CONTROL,
                        self._driver_parameters_slave[WorkhorseParameter2.BANDWIDTH_CONTROL][self.VALUE])
    ...
    def _tst_set_correlation_threshold_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.CORRELATION_THRESHOLD, 50)
        self.assert_set(WorkhorseParameter2.CORRELATION_THRESHOLD, 100)
        self.assert_set(WorkhorseParameter2.CORRELATION_THRESHOLD, 150)
        self.assert_set(WorkhorseParameter2.CORRELATION_THRESHOLD, 200)
        self.assert_set(WorkhorseParameter2.CORRELATION_THRESHOLD, 255)

        self.assert_set_exception(WorkhorseParameter2.CORRELATION_THRESHOLD, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.CORRELATION_THRESHOLD, -256)
        self.assert_set_exception(WorkhorseParameter2.CORRELATION_THRESHOLD, -1)
        self.assert_set_exception(WorkhorseParameter2.CORRELATION_THRESHOLD, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.CORRELATION_THRESHOLD,
                        self._driver_parameters_slave[WorkhorseParameter2.CORRELATION_THRESHOLD][self.VALUE])
    ...
    def _tst_set_error_velocity_threshold_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 0)
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 128)
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 1000)
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 2000)
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 3000)
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 4000)
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 5000)

        self.assert_set_exception(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, -1)
        self.assert_set_exception(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, 10000)
        self.assert_set_exception(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD, -3.1415926)
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD,
                        self._driver_parameters_slave[WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD][self.VALUE])
    ...
    def _tst_set_blank_after_transmit_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 0)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 128)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 1000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 2000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 3000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 4000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 5000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 6000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 7000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 8000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 9000)
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 9999)

        self.assert_set_exception(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, -1)
        self.assert_set_exception(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, 10000)
        self.assert_set_exception(WorkhorseParameter2.BLANK_AFTER_TRANSMIT, -3.1415926)
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.BLANK_AFTER_TRANSMIT,
                        self._driver_parameters_slave[WorkhorseParameter2.BLANK_AFTER_TRANSMIT][self.VALUE])
    ...
    def _tst_set_clip_data_past_bottom_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.CLIP_DATA_PAST_BOTTOM, True)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.CLIP_DATA_PAST_BOTTOM,
                        self._driver_parameters_slave[WorkhorseParameter2.CLIP_DATA_PAST_BOTTOM][self.VALUE])
    ...
    def _tst_set_receiver_gain_select_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.RECEIVER_GAIN_SELECT, 0)
        self.assert_set(WorkhorseParameter2.RECEIVER_GAIN_SELECT, 1)

        self.assert_set_exception(WorkhorseParameter2.RECEIVER_GAIN_SELECT, "LEROY JENKINS")
        self.assert_set_exception(WorkhorseParameter2.RECEIVER_GAIN_SELECT, 2)
        self.assert_set_exception(WorkhorseParameter2.RECEIVER_GAIN_SELECT, -1)
        self.assert_set_exception(WorkhorseParameter2.RECEIVER_GAIN_SELECT, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.RECEIVER_GAIN_SELECT,
                        self._driver_parameters_slave[WorkhorseParameter2.RECEIVER_GAIN_SELECT][self.VALUE])
    ...
    def _tst_set_number_of_depth_cells_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS, 1)
        self.assert_set(WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS, 128)
        self.assert_set(WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS, 254)

        self.assert_set_exception(WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS, 256)
        self.assert_set_exception(WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS, 0)
        self.assert_set_exception(WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS, -1)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS,
                        self._driver_parameters_slave[WorkhorseParameter2.NUMBER_OF_DEPTH_CELLS][self.VALUE])
    ...
    def _tst_set_pings_per_ensemble_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.PINGS_PER_ENSEMBLE, 0)
        self.assert_set(WorkhorseParameter2.PINGS_PER_ENSEMBLE, 16384)

        self.assert_set_exception(WorkhorseParameter2.PINGS_PER_ENSEMBLE, 16385)
        self.assert_set_exception(WorkhorseParameter2.PINGS_PER_ENSEMBLE, -1)
        self.assert_set_exception(WorkhorseParameter2.PINGS_PER_ENSEMBLE, 32767)
        self.assert_set_exception(WorkhorseParameter2.PINGS_PER_ENSEMBLE, 3.1415926)
        self.assert_set_exception(WorkhorseParameter2.PINGS_PER_ENSEMBLE, "LEROY JENKINS")
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.PINGS_PER_ENSEMBLE,
                        self._driver_parameters_slave[WorkhorseParameter2.PINGS_PER_ENSEMBLE][self.VALUE])
    ...
    def _tst_set_depth_cell_size_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.DEPTH_CELL_SIZE, 80)
        self.assert_set_exception(WorkhorseParameter2.DEPTH_CELL_SIZE, 3200)

        self.assert_set_exception(WorkhorseParameter2.DEPTH_CELL_SIZE, 3201)
        self.assert_set_exception(WorkhorseParameter2.DEPTH_CELL_SIZE, -1)
        self.assert_set_exception(WorkhorseParameter2.DEPTH_CELL_SIZE, 2)
        self.assert_set_exception(WorkhorseParameter2.DEPTH_CELL_SIZE, 3.1415926)
        self.assert_set_exception(WorkhorseParameter2.DEPTH_CELL_SIZE, "LEROY JENKINS")
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.DEPTH_CELL_SIZE,
                        self._driver_parameters_slave[WorkhorseParameter2.DEPTH_CELL_SIZE][self.VALUE])
    ...
    def _tst_set_transmit_length_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.TRANSMIT_LENGTH, 80)
        self.assert_set(WorkhorseParameter2.TRANSMIT_LENGTH, 3200)

        self.assert_set_exception(WorkhorseParameter2.TRANSMIT_LENGTH, 3201)
        self.assert_set_exception(WorkhorseParameter2.TRANSMIT_LENGTH, -1)
        self.assert_set_exception(WorkhorseParameter2.TRANSMIT_LENGTH, 3.1415926)
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.TRANSMIT_LENGTH,
                        self._driver_parameters_slave[WorkhorseParameter2.TRANSMIT_LENGTH][self.VALUE])
    ...
    def _tst_set_ping_weight_slave(self):
        ...
        # PING_WEIGHT: (0/1),
        self.assert_set(WorkhorseParameter2.PING_WEIGHT, 0)
        self.assert_set(WorkhorseParameter2.PING_WEIGHT, 1)

        self.assert_set_exception(WorkhorseParameter2.PING_WEIGHT, 2)
        self.assert_set_exception(WorkhorseParameter2.PING_WEIGHT, -1)
        self.assert_set_exception(WorkhorseParameter2.PING_WEIGHT, 3.1415926)
        self.assert_set_exception(WorkhorseParameter2.PING_WEIGHT, "LEROY JENKINS")
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.PING_WEIGHT,
                        self._driver_parameters_slave[WorkhorseParameter2.PING_WEIGHT][self.VALUE])
    ...
    def _tst_set_ambiguity_velocity_slave(self):
        ...
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 2)
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 111)
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 222)
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 333)
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 444)
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 555)
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 666)
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY, 700)

        self.assert_set_exception(WorkhorseParameter2.AMBIGUITY_VELOCITY, 0)
        self.assert_set_exception(WorkhorseParameter2.AMBIGUITY_VELOCITY, 1)
        self.assert_set_exception(WorkhorseParameter2.AMBIGUITY_VELOCITY, -1)
        self.assert_set_exception(WorkhorseParameter2.AMBIGUITY_VELOCITY, 3.1415926)
        self.assert_set_exception(WorkhorseParameter2.AMBIGUITY_VELOCITY, "LEROY JENKINS")

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter2.AMBIGUITY_VELOCITY,
                        self._driver_parameters_slave[WorkhorseParameter2.AMBIGUITY_VELOCITY][self.VALUE])
    ...
    def test_set_parameter_test_slave(self):
        ...
        self.assert_set_exception(WorkhorseParameter2.HEADING_ALIGNMENT, +10000)
        self.assert_set_exception(WorkhorseParameter2.HEADING_ALIGNMENT, +40000)
        self.assert_set_exception(WorkhorseParameter2.ENSEMBLE_PER_BURST, 600)
        self.assert_set_exception(WorkhorseParameter2.ENSEMBLE_PER_BURST, 70000)
        self.assert_set_exception(WorkhorseParameter2.LATENCY_TRIGGER, 1)
        self.assert_set_exception(WorkhorseParameter2.DATA_STREAM_SELECTION, 10)
        self.assert_set_exception(WorkhorseParameter2.DATA_STREAM_SELECTION, 19)
        self.assert_set_exception(WorkhorseParameter2.BUFFERED_OUTPUT_PERIOD, "00:00:11")
    ...
    def test_startup_params_slave(self):
        ...
        get_values = {
            WorkhorseParameter2.SERIAL_FLOW_CONTROL: '11110',
            WorkhorseParameter2.BANNER: False,
            WorkhorseParameter2.INSTRUMENT_ID: 0,
            WorkhorseParameter2.SLEEP_ENABLE: 0,
            WorkhorseParameter2.SAVE_NVRAM_TO_RECORDER: True,
            WorkhorseParameter2.POLLED_MODE: False,
            WorkhorseParameter2.XMIT_POWER: 255,
            WorkhorseParameter2.SPEED_OF_SOUND: 1485,
            WorkhorseParameter2.PITCH: 0,
            WorkhorseParameter2.ROLL: 0,
            WorkhorseParameter2.SALINITY: 35,
            WorkhorseParameter2.TIME_PER_ENSEMBLE: '00:00:00.00',
            WorkhorseParameter2.FALSE_TARGET_THRESHOLD: '050,001',
            WorkhorseParameter2.BANDWIDTH_CONTROL: 0,
            WorkhorseParameter2.CORRELATION_THRESHOLD: 64,
            WorkhorseParameter2.SERIAL_OUT_FW_SWITCHES: '111100000',
            WorkhorseParameter2.ERROR_VELOCITY_THRESHOLD: 2000,
            WorkhorseParameter2.CLIP_DATA_PAST_BOTTOM: False,
            WorkhorseParameter2.RECEIVER_GAIN_SELECT: 1,
            WorkhorseParameter2.PINGS_PER_ENSEMBLE: 1,
            WorkhorseParameter2.TRANSMIT_LENGTH: 0,
            WorkhorseParameter2.PING_WEIGHT: 0,
            WorkhorseParameter2.AMBIGUITY_VELOCITY: 175,
            WorkhorseParameter2.SERIAL_DATA_OUT: '000 000 000',
            WorkhorseParameter2.LATENCY_TRIGGER: False,
            WorkhorseParameter2.HEADING_ALIGNMENT: +00000,
            WorkhorseParameter2.HEADING_BIAS: +00000,
            WorkhorseParameter2.DATA_STREAM_SELECTION: 0,
            WorkhorseParameter2.ENSEMBLE_PER_BURST: 0,
            WorkhorseParameter2.SAMPLE_AMBIENT_SOUND: False,
            WorkhorseParameter2.BUFFERED_OUTPUT_PERIOD: '00:00:00'
        }
        new_set = {
...
class QualFromIDK(WorkhorseDriverQualificationTest, VADCPMixin):
    ...
    def test_direct_access_telnet_mode_master(self):
        ...
        self.assert_set_parameter(VadcpParameter.SPEED_OF_SOUND, 1487)
        ...
        self.assert_get_parameter(VadcpParameter.SPEED_OF_SOUND, 1487)
    ...
    def test_recover_from_TG(self):
        ...
        self.assert_get_parameter(VadcpParameter.TIME_OF_FIRST_PING, '****/**/**,**:**:**')
