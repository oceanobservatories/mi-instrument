...
from mi.instrument.teledyne.workhorse.driver import WorkhorseScheduledJob, WorkhorseCapability, \
    WorkhorseProtocolState, WorkhorseProtocolEvent, WorkhorsePrompt, WorkhorseParameter, WorkhorseInstrumentCmds, \
    NEWLINE
...
class VADCPMixin(DriverTestMixin):
    ...
    _vadcp_driver_parameters = {
        ...
        WorkhorseParameter.SERIAL_OUT_FW_SWITCHES: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '111100000',
                                           VALUE: '111100000'},
        ...
        WorkhorseParameter.POLLED_MODE: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: False, VALUE: False},
        WorkhorseParameter.XMIT_POWER: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 255, VALUE: 255},
        WorkhorseParameter.SPEED_OF_SOUND: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1485, VALUE: 1485},
        ...
        WorkhorseParameter.COORDINATE_TRANSFORMATION: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '00111',
                                              VALUE: '00111'},
        ...
        WorkhorseParameter.TIME_PER_PING: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: '00:01.00',
                                  VALUE: '00:01.00'},
        WorkhorseParameter.FALSE_TARGET_THRESHOLD: {TYPE: str, READONLY: False, DA: True, STARTUP: True, DEFAULT: '050,001',
                                           VALUE: '050,001'},
        WorkhorseParameter.BANDWIDTH_CONTROL: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        WorkhorseParameter.CORRELATION_THRESHOLD: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 64, VALUE: 64},
        WorkhorseParameter.ERROR_VELOCITY_THRESHOLD: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 2000,
                                             VALUE: 2000},
        WorkhorseParameter.BLANK_AFTER_TRANSMIT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 88, VALUE: 88},
        WorkhorseParameter.CLIP_DATA_PAST_BOTTOM: {TYPE: bool, READONLY: False, DA: True, STARTUP: True, DEFAULT: False,
                                          VALUE: 0},
        WorkhorseParameter.RECEIVER_GAIN_SELECT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        WorkhorseParameter.NUMBER_OF_DEPTH_CELLS: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 220, VALUE: 220},
        WorkhorseParameter.PINGS_PER_ENSEMBLE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        WorkhorseParameter.DEPTH_CELL_SIZE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 100, VALUE: 100},
        WorkhorseParameter.TRANSMIT_LENGTH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        WorkhorseParameter.PING_WEIGHT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        WorkhorseParameter.AMBIGUITY_VELOCITY: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 175, VALUE: 175},
        ...
        WorkhorseParameter.HEADING_BIAS: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: +00000,
                                 VALUE: +00000},
        WorkhorseParameter.TRANSDUCER_DEPTH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 2000, VALUE: 2000},
        WorkhorseParameter.DATA_STREAM_SELECTION: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        WorkhorseParameter.ENSEMBLE_PER_BURST: {TYPE: int, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        WorkhorseParameter.BUFFERED_OUTPUT_PERIOD: {TYPE: str, READONLY: True, DA: True, STARTUP: True, DEFAULT: '00:00:00',
                                           VALUE: '00:00:00'},
        WorkhorseParameter.SAMPLE_AMBIENT_SOUND: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
        ...
        WorkhorseParameter.CLOCK_SYNCH_INTERVAL: {TYPE: str, READONLY: False, DA: False, STARTUP: True, DEFAULT: '00:00:00',
                                         VALUE: '00:00:00'},
        WorkhorseParameter.GET_STATUS_INTERVAL: {TYPE: str, READONLY: False, DA: False, STARTUP: True, DEFAULT: '00:00:00',
                                        VALUE: '00:00:00'}
    }
    ...
    _driver_parameters_slave = {
        ...
        WorkhorseParameter.ERROR_VELOCITY_THRESHOLD: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 2000,
                                              VALUE: 2000},
        WorkhorseParameter.BLANK_AFTER_TRANSMIT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 83, VALUE: 83},
        WorkhorseParameter.CLIP_DATA_PAST_BOTTOM: {TYPE: bool, READONLY: False, DA: True, STARTUP: True, DEFAULT: False,
                                           VALUE: 0},
        WorkhorseParameter.RECEIVER_GAIN_SELECT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        WorkhorseParameter.NUMBER_OF_DEPTH_CELLS: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 220, VALUE: 220},
        WorkhorseParameter.PINGS_PER_ENSEMBLE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 1, VALUE: 1},
        WorkhorseParameter.DEPTH_CELL_SIZE: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 94, VALUE: 94},
        WorkhorseParameter.TRANSMIT_LENGTH: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        WorkhorseParameter.PING_WEIGHT: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: False, VALUE: 0},
        WorkhorseParameter.AMBIGUITY_VELOCITY: {TYPE: int, READONLY: False, DA: True, STARTUP: True, DEFAULT: 175, VALUE: 175},
        WorkhorseParameter.LATENCY_TRIGGER: {TYPE: bool, READONLY: True, DA: True, STARTUP: True, DEFAULT: 0, VALUE: 0},
    ...
    for key in _driver_parameters_slave.keys():
        _driver_parameters_slave[key + '_5th'] = _driver_parameters_slave[key]
        del _driver_parameters_slave[key]
...
class VadcpDriverUnitTest(WorkhorseDriverUnitTest, VADCPMixin):
    ...
    def test_got_data(self):
        ...
        # Start validating data particles
        self.assert_particle_published(driver, RSN_CALIBRATION_RAW_DATA, self.assert_particle_compass_calibration, True)
        self.assert_particle_published(driver, VADCP_SLAVE_PS0_RAW_DATA, self.assert_particle_5b_system_configuration, True)
        self.assert_particle_published(driver, RSN_SAMPLE_RAW_DATA, self.assert_particle_pd0_data, True)
        self.assert_particle_published(driver, PT2_RAW_DATA, self.assert_particle_pt2_data, True)
        self.assert_particle_published(driver, PT4_RAW_DATA, self.assert_particle_pt4_data, True)
...
class VadcpDriverIntegrationTest(WorkhorseDriverIntegrationTest, VADCPMixin):
    ...
    def test_autosample_particle_generation(self):
        ...
        self.assert_driver_command(WorkhorseProtocolEvent.STOP_AUTOSAMPLE, state=WorkhorseProtocolState.COMMAND, delay=1)
    ...
    def _tst_set_xmit_power_slave(self):
        ...
        self.assert_set(WorkhorseParameter.XMIT_POWER,
                        self._driver_parameters_slave[WorkhorseParameter.XMIT_POWER][self.VALUE])
    ...
    def _tst_set_pitch_slave(self):
        ...
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter.PITCH, self._driver_parameters_slave[WorkhorseParameter.PITCH][self.VALUE])
    ...
    def _tst_set_roll_slave(self):
        ...
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter.ROLL, self._driver_parameters_slave[WorkhorseParameter.ROLL][self.VALUE])
    ...
    def _tst_set_speed_of_sound_slave(self):
        ...
        self.assert_set(WorkhorseParameter.SPEED_OF_SOUND,
                        self._driver_parameters_slave[WorkhorseParameter.SPEED_OF_SOUND][self.VALUE])
    ...
    def _tst_set_salinity_slave(self):
        ...
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter.SALINITY,
                        self._driver_parameters_slave[WorkhorseParameter.SALINITY][self.VALUE])
    ...
    def _tst_set_sensor_source_slave(self):
        ...
        self.assert_set(WorkhorseParameter.SENSOR_SOURCE,
                        self._driver_parameters_slave[WorkhorseParameter.SENSOR_SOURCE][self.VALUE])
    ...
    def _tst_set_time_per_ensemble_slave(self):
        ...
        self.assert_set(WorkhorseParameter.TIME_PER_ENSEMBLE,
                        self._driver_parameters_slave[WorkhorseParameter.TIME_PER_ENSEMBLE][self.VALUE])
    ...
    def _tst_set_false_target_threshold_slave(self):
        ...
        self.assert_set(WorkhorseParameter.FALSE_TARGET_THRESHOLD,
                        self._driver_parameters_slave[WorkhorseParameter.FALSE_TARGET_THRESHOLD][self.VALUE])
    ...
    def _tst_set_bandwidth_control_slave(self):
        ...
        self.assert_set(WorkhorseParameter.BANDWIDTH_CONTROL,
                        self._driver_parameters_slave[WorkhorseParameter.BANDWIDTH_CONTROL][self.VALUE])
    ...
    def _tst_set_correlation_threshold_slave(self):
        ...
        self.assert_set_exception(WorkhorseParameter.CORRELATION_THRESHOLD, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter.CORRELATION_THRESHOLD,
                        self._driver_parameters_slave[WorkhorseParameter.CORRELATION_THRESHOLD][self.VALUE])
    ...
    def _tst_set_error_velocity_threshold_slave(self):
        ...
        self.assert_set(WorkhorseParameter.ERROR_VELOCITY_THRESHOLD, 1000)
        self.assert_set(WorkhorseParameter.ERROR_VELOCITY_THRESHOLD, 2000)
        self.assert_set(WorkhorseParameter.ERROR_VELOCITY_THRESHOLD, 3000)
        self.assert_set(WorkhorseParameter.ERROR_VELOCITY_THRESHOLD, 4000)
        ...
        self.assert_set(WorkhorseParameter.ERROR_VELOCITY_THRESHOLD,
                        self._driver_parameters_slave[WorkhorseParameter.ERROR_VELOCITY_THRESHOLD][self.VALUE])
    ...
    def _tst_set_blank_after_transmit_slave(self):
        ...
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 1000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 2000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 3000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 4000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 5000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 6000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 7000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 8000)
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT, 9000)
        ...
        self.assert_set(WorkhorseParameter.BLANK_AFTER_TRANSMIT,
                        self._driver_parameters_slave[WorkhorseParameter.BLANK_AFTER_TRANSMIT][self.VALUE])
    ...
    def _tst_set_clip_data_past_bottom_slave(self):
        ...
        self.assert_set(WorkhorseParameter.CLIP_DATA_PAST_BOTTOM,
                        self._driver_parameters_slave[WorkhorseParameter.CLIP_DATA_PAST_BOTTOM][self.VALUE])
    ...
    def _tst_set_receiver_gain_select_slave(self):
        ...
        self.assert_set_exception(WorkhorseParameter.RECEIVER_GAIN_SELECT, "LEROY JENKINS")
        ...
        self.assert_set_exception(WorkhorseParameter.RECEIVER_GAIN_SELECT, 3.1415926)

        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter.RECEIVER_GAIN_SELECT,
                        self._driver_parameters_slave[WorkhorseParameter.RECEIVER_GAIN_SELECT][self.VALUE])
    ...
    def _tst_set_number_of_depth_cells_slave(self):
        ...
        self.assert_set(WorkhorseParameter.NUMBER_OF_DEPTH_CELLS, 254)
        ...
        self.assert_set(WorkhorseParameter.NUMBER_OF_DEPTH_CELLS,
                        self._driver_parameters_slave[WorkhorseParameter.NUMBER_OF_DEPTH_CELLS][self.VALUE])
    ...
    def _tst_set_pings_per_ensemble_slave(self):
        ...
        self.assert_set_exception(WorkhorseParameter.PINGS_PER_ENSEMBLE, 3.1415926)
        ...
        self.assert_set(WorkhorseParameter.PINGS_PER_ENSEMBLE,
                        self._driver_parameters_slave[WorkhorseParameter.PINGS_PER_ENSEMBLE][self.VALUE])
    ...
    def _tst_set_depth_cell_size_slave(self):
        ...
        self.assert_set_exception(WorkhorseParameter.DEPTH_CELL_SIZE, 3200)
        ...
        self.assert_set(WorkhorseParameter.DEPTH_CELL_SIZE,
                        self._driver_parameters_slave[WorkhorseParameter.DEPTH_CELL_SIZE][self.VALUE])
    ...
    def _tst_set_transmit_length_slave(self):
        ...
        self.assert_set_exception(WorkhorseParameter.TRANSMIT_LENGTH, 3.1415926)
        #
        # Reset to good value.
        #
        self.assert_set(WorkhorseParameter.TRANSMIT_LENGTH,
                        self._driver_parameters_slave[WorkhorseParameter.TRANSMIT_LENGTH][self.VALUE])
    ...
    def _tst_set_ping_weight_slave(self):
        ...
        self.assert_set(WorkhorseParameter.PING_WEIGHT,
                        self._driver_parameters_slave[WorkhorseParameter.PING_WEIGHT][self.VALUE])
    ...
    def _tst_set_ambiguity_velocity_slave(self):
        ...
        self.assert_set(WorkhorseParameter.AMBIGUITY_VELOCITY, 111)
        self.assert_set(WorkhorseParameter.AMBIGUITY_VELOCITY, 222)
        self.assert_set(WorkhorseParameter.AMBIGUITY_VELOCITY, 333)
        self.assert_set(WorkhorseParameter.AMBIGUITY_VELOCITY, 444)
        self.assert_set(WorkhorseParameter.AMBIGUITY_VELOCITY, 555)
        self.assert_set(WorkhorseParameter.AMBIGUITY_VELOCITY, 666)
        ...
        self.assert_set_exception(WorkhorseParameter.AMBIGUITY_VELOCITY, -1)
        self.assert_set_exception(WorkhorseParameter.AMBIGUITY_VELOCITY, 3.1415926)
        ...
        self.assert_set(WorkhorseParameter.AMBIGUITY_VELOCITY,
                        self._driver_parameters_slave[WorkhorseParameter.AMBIGUITY_VELOCITY][self.VALUE])
