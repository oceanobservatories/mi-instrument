...
class ADCPTMixin(DriverTestMixin):
    ...
    def assert_particle_pd0_error_status(self, data_particle, verify_values=False):
        """
        Verify an adcp ps0 data particle
        @param data_particle: ADCP_PS0DataParticle data particle
        @param verify_values: bool, should we verify parameter values
        """
        self.assert_data_particle_header(data_particle, WorkhorseDataParticleType.ADCP_PD0_ERROR_STATUS)
