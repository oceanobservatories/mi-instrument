...
from mi.instrument.teledyne.workhorse.adcp.test.test_data import RSN_CALIBRATION_RAW_DATA
...
class ADCPTMixin(DriverTestMixin):
    ...
    _pd0_parameters_base = {
        ...
        AdcpPd0ParsedKey.ENSEMBLE_START_TIME: {'type': float, 'value': 3572397182.46},
    ...
    def assert_particle_pd0_data_earth(self, data_particle, verify_values=False):
        ...
        @param verify_values: bool, should we verify parameter values
        """
        self.assert_data_particle_header(data_particle, DataParticleType.ADCP_PD0_PARSED_EARTH, True)
