...
from mi.idk.unit_test import InstrumentDriverTestCase, InstrumentDriverUnitTestCase, \
    InstrumentDriverIntegrationTestCase, \
    InstrumentDriverQualificationTestCase, AgentCapabilityType

from mi.instrument.teledyne.workhorse.adcp.test.test_data import RSN_SAMPLE_RAW_DATA, PT2_RAW_DATA
from mi.instrument.teledyne.workhorse.adcp.test.test_data import PT4_RAW_DATA, RSN_CALIBRATION_RAW_DATA
...
from mi.instrument.teledyne.workhorse.adcp.driver import NEWLINE
from mi.instrument.teledyne.workhorse.adcp.driver import DataParticleType
from mi.instrument.teledyne.workhorse.adcp.driver import AdcpCompassCalibrationKey
from mi.instrument.teledyne.workhorse.adcp.driver import AdcpSystemConfigurationKey
from mi.instrument.teledyne.workhorse.adcp.driver import AdcpPd0ParsedKey
from mi.instrument.teledyne.workhorse.adcp.driver import AdcpAncillarySystemDataKey
from mi.instrument.teledyne.workhorse.adcp.driver import AdcpTransmitPathKey
...
class ADCPTMixin(DriverTestMixin):
    ...
    def assert_transmit_data(self, data_particle, verify_values=True):
        ...
        @param verify_values: bool, should we verify parameter values
        """
        self.assert_data_particle_header(data_particle, DataParticleType.ADCP_TRANSMIT_PATH, verify_values)
    ...
    def assert_ancillary_data(self, data_particle, verify_values=True):
        ...
        @param verify_values: bool, should we verify parameter values
        """
        self.assert_data_particle_header(data_particle, DataParticleType.ADCP_ANCILLARY_SYSTEM_DATA, verify_values)

    def assert_calibration(self, data_particle, verify_values=True):
        self.assert_data_particle_header(data_particle, DataParticleType.ADCP_COMPASS_CALIBRATION, verify_values)
...
###############################################################################
@attr('UNIT', group='mi')
class UnitFromIDK(InstrumentDriverUnitTestCase, ADCPTMixin):
    def setUp(self):
...
###############################################################################
@attr('INT', group='mi')
class IntFromIDK(InstrumentDriverIntegrationTestCase, ADCPTMixin):
    def setUp(self):
    ...
    def test_scheduled_interval_clock_sync_command(self):
        ...
        """
        self.assert_initialize_driver()
        self.assert_set(Parameter.CLOCK_SYNCH_INTERVAL, '00:00:04')
        time.sleep(10)

        self.assert_set(Parameter.CLOCK_SYNCH_INTERVAL, '00:00:00')
    ...
    def test_scheduled_interval_acquire_status_command(self):
        ...
        """
        self.assert_initialize_driver()
        self.assert_set(Parameter.GET_STATUS_INTERVAL, '00:00:04')
        ...
        self.assert_set(Parameter.GET_STATUS_INTERVAL, '00:00:00')
    ...
    def test_set_parameter_test(self):
        ...
        self.assert_set_exception(Parameter.HEADING_ALIGNMENT, +10000)
        self.assert_set_exception(Parameter.HEADING_ALIGNMENT, +40000)
        self.assert_set_exception(Parameter.ENSEMBLE_PER_BURST, 600)
        self.assert_set_exception(Parameter.ENSEMBLE_PER_BURST, 70000)
        self.assert_set_exception(Parameter.LATENCY_TRIGGER, 1)
        self.assert_set_exception(Parameter.DATA_STREAM_SELECTION, 10)
        self.assert_set_exception(Parameter.DATA_STREAM_SELECTION, 19)
        self.assert_set_exception(Parameter.BUFFERED_OUTPUT_PERIOD, "00:00:11")
    ...
    def test_commands(self):
        ...
        self.assert_driver_command(ProtocolEvent.SAVE_SETUP_TO_RAM,
        ...
        self.assert_driver_command(ProtocolEvent.FACTORY_SETS)
        self.assert_driver_command(ProtocolEvent.USER_SETS)
        self.assert_driver_command(ProtocolEvent.ACQUIRE_STATUS)
        ...
        ####
        # Test a bad command
        # TODO: something is broken in exception passing, restore this test when fixed
        ####
    ...
    def _tst_set_xmit_power(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.XMIT_POWER, self._driver_parameters[Parameter.XMIT_POWER][self.VALUE])
    ...
    def _tst_set_speed_of_sound(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.SPEED_OF_SOUND,
                        self._driver_parameters[Parameter.SPEED_OF_SOUND][self.VALUE])
    ...
    def _tst_set_salinity(self):
        ...
        # SALINITY:  -- Int (0 - 40)
        self.assert_set(Parameter.SALINITY, 1)
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.SALINITY, self._driver_parameters[Parameter.SALINITY][self.VALUE])
    ...
    def _tst_set_sensor_source(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.SENSOR_SOURCE,
                        self._driver_parameters[Parameter.SENSOR_SOURCE][self.VALUE])
    ...
    def _tst_set_time_per_ensemble(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.TIME_PER_ENSEMBLE,
                        self._driver_parameters[Parameter.TIME_PER_ENSEMBLE][self.VALUE])
    ...
    def _tst_set_pitch(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.PITCH, self._driver_parameters[Parameter.PITCH][self.VALUE])
    ...
    def _tst_set_roll(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.ROLL, self._driver_parameters[Parameter.ROLL][self.VALUE])
    ...
    def _tst_set_time_per_ping(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.TIME_PER_PING,
                        self._driver_parameters[Parameter.TIME_PER_PING][self.VALUE])
    ...
    def _tst_set_false_target_threshold(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.FALSE_TARGET_THRESHOLD,
                        self._driver_parameters[Parameter.FALSE_TARGET_THRESHOLD][self.VALUE])
    ...
    def _tst_set_bandwidth_control(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.BANDWIDTH_CONTROL,
                        self._driver_parameters[Parameter.BANDWIDTH_CONTROL][self.VALUE])
    ...
    def _tst_set_correlation_threshold(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.CORRELATION_THRESHOLD,
                        self._driver_parameters[Parameter.CORRELATION_THRESHOLD][self.VALUE])
    ...
    def _tst_set_error_velocity_threshold(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.ERROR_VELOCITY_THRESHOLD,
                        self._driver_parameters[Parameter.ERROR_VELOCITY_THRESHOLD][self.VALUE])
    ...
    def _tst_set_blank_after_transmit(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.BLANK_AFTER_TRANSMIT,
                        self._driver_parameters[Parameter.BLANK_AFTER_TRANSMIT][self.VALUE])
    ...
    def _tst_set_clip_data_past_bottom(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.CLIP_DATA_PAST_BOTTOM,
                        self._driver_parameters[Parameter.CLIP_DATA_PAST_BOTTOM][self.VALUE])
    ...
    def _tst_set_receiver_gain_select(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.RECEIVER_GAIN_SELECT,
                        self._driver_parameters[Parameter.RECEIVER_GAIN_SELECT][self.VALUE])
    ...
    def _tst_set_number_of_depth_cells(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.NUMBER_OF_DEPTH_CELLS,
                        self._driver_parameters[Parameter.NUMBER_OF_DEPTH_CELLS][self.VALUE])
    ...
    def _tst_set_pings_per_ensemble(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.PINGS_PER_ENSEMBLE,
                        self._driver_parameters[Parameter.PINGS_PER_ENSEMBLE][self.VALUE])
    ...
    def _tst_set_depth_cell_size(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.DEPTH_CELL_SIZE,
                        self._driver_parameters[Parameter.DEPTH_CELL_SIZE][self.VALUE])
    ...
    def _tst_set_transmit_length(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.TRANSMIT_LENGTH,
                        self._driver_parameters[Parameter.TRANSMIT_LENGTH][self.VALUE])
    ...
    def _tst_set_ping_weight(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.PING_WEIGHT,
                        self._driver_parameters[Parameter.PING_WEIGHT][self.VALUE])
    ...
    def _tst_set_ambiguity_velocity(self):
        ...
        # Reset to good value.
        #
        self.assert_set(Parameter.AMBIGUITY_VELOCITY,
                        self._driver_parameters[Parameter.AMBIGUITY_VELOCITY][self.VALUE])
...
class WorkhorseDriverQualificationTest(InstrumentDriverQualificationTestCase):
    ...
    def _test_execute_clock_sync(self):
        ...
        instrument_time = time.mktime(
            time.strptime(check_new_params.get(Parameter.TIME).lower(), "%Y/%m/%d,%H:%M:%S %Z"))
    ...
    def test_startup_params_first_pass(self):
        ...
        self.assert_set_parameter(Parameter.TRANSDUCER_DEPTH, 6000, False)
        self.assert_set_parameter(Parameter.TRANSDUCER_DEPTH, 0)

        self.assert_set_parameter(Parameter.TIME_PER_ENSEMBLE, '00:00:01.00')
        self.assert_set_parameter(Parameter.TIME_PER_ENSEMBLE, '01:00:00.00')
    ...
    def test_startup_params_second_pass(self):
        ...
        self.assert_set_parameter(Parameter.ERROR_VELOCITY_THRESHOLD, 1999)
        self.assert_set_parameter(Parameter.BLANK_AFTER_TRANSMIT, 714)
        self.assert_set_parameter(Parameter.BLANK_AFTER_TRANSMIT, 352)
        self.assert_set_parameter(Parameter.CLIP_DATA_PAST_BOTTOM, 1)
        self.assert_set_parameter(Parameter.RECEIVER_GAIN_SELECT, 0)
        self.assert_set_parameter(Parameter.NUMBER_OF_DEPTH_CELLS, 99)
        self.assert_set_parameter(Parameter.NUMBER_OF_DEPTH_CELLS, 30)
        self.assert_set_parameter(Parameter.PINGS_PER_ENSEMBLE, 0)
        self.assert_set_parameter(Parameter.PINGS_PER_ENSEMBLE, 1)
        self.assert_set_parameter(Parameter.DEPTH_CELL_SIZE, 790)
        self.assert_set_parameter(Parameter.TRANSMIT_LENGTH, 1)
        self.assert_set_parameter(Parameter.PING_WEIGHT, 1)
        self.assert_set_parameter(Parameter.AMBIGUITY_VELOCITY, 176)
