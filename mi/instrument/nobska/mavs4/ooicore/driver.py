...
class mavs4InstrumentProtocol(MenuInstrumentProtocol):
    ...
    def _handler_unknown_discover(self):
        ...
        if samples:
            log.debug('DJM - got samples - instrument in autosample')
    ...
    @staticmethod
    def _set_query_mode_parameter(params_to_set):
        """
    ...
    def _handler_command_clock_sync(self):
        """
    ...
    def _handler_autosample_clock_sync(self):
        """
    ...
    def _build_enter_log_display_acoustic_axis_velocities_command(self):
        """
    ...
    def _build_enter_log_display_acoustic_axis_velocity_format_command(self):
        """
