...
class Protocol(InstrumentProtocol):
    ...
    def _build_command_dict(self):
        ...
        self._cmd_dict.add(Capability.START_ION, display_name="Start Ion Chamber Regeneration Sequence")
        self._cmd_dict.add(Capability.START_NAFION, display_name="Start Nafion Regeneration Sequence")
        self._cmd_dict.add(Capability.STOP_REGEN, display_name="Stop Current Regeneration Sequence")
