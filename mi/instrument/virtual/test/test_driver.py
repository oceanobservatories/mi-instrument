...
class DriverUnitTest(unittest.TestCase):
    ...
    def test_sample_rate(self):
        ...
        log.error('count(100) : %.2f', timeit.timeit(functools.partial(driver._protocol._generate_particle, 'botpt_nano_sample', count=500), number=1))
        log.error('particles : %.2f', timeit.timeit(particle.generate, number=500))
