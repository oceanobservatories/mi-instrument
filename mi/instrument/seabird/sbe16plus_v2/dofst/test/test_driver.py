"""
@package mi.instrument.seabird.sbe16plus_v2.dofst.test.test_driver
@file mi-instrument/mi/instrument/seabird/sbe16_plus_v2/dofst/test/test_driver.py
@author Mark Steiner
@brief Test cases for dofst attached to a ctdpf_sbe43
...
from mi.instrument.seabird.sbe16plus_v2.ctdpf_sbe43.driver import Parameter  # shares the CTD parameters, read-only

from mi.instrument.seabird.sbe16plus_v2.dofst.driver import \
    Capability, \
    DataParticleType, \
    DoFastSampleParticleKey, \
    InstrumentDriver, \
    Protocol
...
InstrumentDriverTestCase.initialize(
    driver_module='mi.instrument.seabird.sbe16plus_v2.dofst.driver',
    driver_class="InstrumentDriver",

    instrument_agent_resource_id='JI22B5',
    instrument_agent_name='seabird_sbe16plus_v2_dofst',
...
class UtilMixin(DriverTestMixin):
    ...
    _sbe43_sample = {
        DoFastSampleParticleKey.EXT_VOLT0: {TYPE: int, VALUE: 23025, REQUIRED: True},
    }
    ...
    def assert_sbe43_particle_sample(self, data_particle, verify_values=False):
        ...
        """
        self.assert_data_particle_keys(DoFastSampleParticleKey, self._sbe43_sample)
