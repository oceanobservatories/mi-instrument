...
class SBE19ConfigurationParticle(SeaBirdParticle):
    ...
    def _build_parsed_values(self):
        ...
        serial_number = str(root.getAttribute(SERIAL_NUMBER))
    ...
    def _build_parsed_values(self):
        ...
        for sensor in sensors:
            ...
            if sensor_id == TEMPERATURE_SENSOR_ID:
                temperature_sensor_serial_number = str(self._extract_xml_element_value(sensor, SERIAL_NUMBER))
            elif sensor_id == CONDUCTIVITY_SENSOR_ID:
                conductivity_sensor_serial_number = str(self._extract_xml_element_value(sensor, SERIAL_NUMBER))
