...
ENGINEERING_DATA_REGEX = r"<MainSupplyVoltage>([.\d]+)</MainSupplyVoltage>"
...
class SBE54tpsStatusDataParticle(DataParticle):
    ...
    def _build_parsed_values(self):
        ...
        log.debug('parsed SBE54tpsStatusDataParticle particle = %r', result)
...
class SBE54tpsConfigurationDataParticle(DataParticle):
    ...
    def _build_parsed_values(self):
        ...
        log.debug('parsed SBE54tpsConfigurationDataParticle particle = %r', result)
...
class SBE54tpsEventCounterDataParticle(DataParticle):
    ...
    def _build_parsed_values(self):
        ...
        log.debug('parsed SBE54tpsEventCounterDataParticle particle = %r', result)
...
class SBE54tpsHardwareDataParticle(DataParticle):
    ...
    def _build_parsed_values(self):
        ...
        matchers = {
            ...
            re.compile(self.LINE8): [SBE54tpsHardwareDataParticleKey.MANUFACTURER_DATE]
        }
        ...
        log.debug('parsed SBE54tpsHardwareDataParticle particle = %r', result)
...
class SBE54tpsSampleDataParticle(DataParticle):
    ...
    def _build_parsed_values(self):
        ...
        log.debug('parsed SBE54tpsSampleDataParticle particle = %r', result)
...
class SBE54tpsSampleRefOscDataParticle(DataParticle):
    ...
    def _build_parsed_values(self):
        ...
        log.debug('parsed SBE54tpsSampleRefOscDataParticle particle = %r', result)
...
class Protocol(SeaBirdProtocol):
    ...
    def _handler_autosample_init_params(self, *args, **kwargs):
        ...
        if self._init_type != InitializationType.NONE:
            ...
            # Catch all error so we can put back into
            # streaming.  Then rethrow the error
            except Exception as e:
                error = e
            ...
            if error:
                log.error("Error in _handler_autosample_init_params: %s", error)
                raise error
