...
class SatlanticOCR507InstrumentProtocol(CommandResponseInstrumentProtocol):
    ...
    def __init__(self, callback=None):
        ...
        self._param_dict.add(Parameter.INIT_AT,
                             ...
                             description="Enables or disables auto telemetry: (off|on)",
                             default_value=True,
        ...
        self._param_dict.add(Parameter.INIT_SM,
                             ...
                             description="Enables or disables silent mode: (off|on)",
                             default_value=True,
                             visibility=ParameterDictVisibility.IMMUTABLE,
                             startup_param=True,
                             direct_access=True)
        ...
        self._param_dict.add(Parameter.NET_MODE,
                             ...
                             description="Enables or disables network operation for the instrument (off|on)",
                             default_value=False,
                             visibility=ParameterDictVisibility.IMMUTABLE,
                             startup_param=True,
                             direct_access=True)
