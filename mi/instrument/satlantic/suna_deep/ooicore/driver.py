...
class Protocol(CommandResponseInstrumentProtocol):
    ...
    def _build_param_dict(self):
        ...
        self._param_dict.add(Parameter.PERIODIC_OFFSET,
                             ...
                             description="Measured in seconds. Locates the time grid"
                                         " relative to the start of the day in Periodic Mode",
                             units=Units.SECOND)
        ...
        self._param_dict.add(Parameter.PERIODIC_DURATION,
                             ...
                             description="Number of seconds over which data will be collected in Periodic mode when"
                                         " Operation Control is Duration (0-255)",
                             units=Units.SECOND)
    ...
    def _handler_unknown_discover(self):
        ...
        elif mode == InstrumentCommandArgs.PERIODIC:
            # Instrument is in PERIODIC state. Sampling will resume after param init.
            next_state = ProtocolState.PERIODIC
    ...
    def _change_state(self, next_state):
        ...
        if next_state == ProtocolState.COMMAND:
            args = InstrumentCommandArgs.POLLED
        elif next_state == ProtocolState.AUTOSAMPLE:
            args = InstrumentCommandArgs.CONTINUOUS
        elif next_state == ProtocolState.PERIODIC:
            args = InstrumentCommandArgs.PERIODIC
        else:
