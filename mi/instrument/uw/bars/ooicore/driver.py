...
class Protocol(MenuInstrumentProtocol):
    ...
    def _set_trhph_params(self, params):
        ...
        for (key, val) in params.iteritems():
            ...
            #todo WHEN IN AUTOSAMPLE STATE, ALL READONLY PARAMS CHANGE VALUE TO UNKNOWN.  HIGHLY SUSPECT!!!!
    ...
    def _build_param_dict(self):
        ...
        self._param_dict.add(Parameter.VERBOSE,
                             ...
                             direct_access=True,
                             init_value=0,
                             value=0, #TODO - HAD PROBLEMS COMPARING VALUES BEFORE SETTING DURING INIT BECAUSE VALUE WASN'T SET IN UPDATE PARAMS (NO WAY TO GET VALUE FROM INSTRUMENT)
