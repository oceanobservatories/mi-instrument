...
class Protocol(NortekInstrumentProtocol):
    ...
    def _build_param_dict(self):
        ...
        self._param_dict.add_basic(Parameter.SAMPLE_RATE,
                                   ...
                                   startup_param=False,
                                   direct_access=False)
        self._param_dict.set_default(Parameter.TRANSMIT_PULSE_LENGTH, 2)
        self._param_dict.set_default(Parameter.BLANKING_DISTANCE, 16)
        self._param_dict.set_default(Parameter.RECEIVE_LENGTH, 7)
        self._param_dict.set_default(Parameter.TIME_BETWEEN_PINGS, 44)
        self._param_dict.set_default(Parameter.TIME_BETWEEN_BURST_SEQUENCES, 0)
        self._param_dict.set_default(Parameter.NUMBER_PINGS, 0)
        self._param_dict.set_default(Parameter.AVG_INTERVAL, 64)
        self._param_dict.set_default(Parameter.MEASUREMENT_INTERVAL, 600)
        self._param_dict.set_default(Parameter.DIAGNOSTIC_INTERVAL, 10800)
        self._param_dict.set_default(Parameter.ADJUSTMENT_SOUND_SPEED, 16657)
        self._param_dict.set_default(Parameter.NUMBER_SAMPLES_DIAGNOSTIC, 1)
        self._param_dict.set_default(Parameter.ANALOG_OUTPUT_SCALE, 6711)
