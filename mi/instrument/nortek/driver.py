...
class NortekInstrumentProtocol(CommandResponseInstrumentProtocol):
    ...
    #
    #         if len(binary_config) == common.USER_CONFIG_LEN + 2:
    #             if _check_configuration(binary_config, common.USER_CONFIG_SYNC_BYTES, common.USER_CONFIG_LEN):
    ...
    def _update_params(self):
        ...
        for each in Parameter.list():
            if hasattr(user_config, each) and each in self._param_dict._param_dict:
